...
const Layout = () => {
    ...
    function engageCookie() {
        const Username = localStorage.getItem("Username")
        createCookie("User:", Username, 30);
        localStorage.setItem("cookiesPresent", true);
    ...
    return (
        <>
            ...
            <div className="cookieCard cookieZoom cookieUnZoom" id="cookieCard">
                ...
                <div className="abolishCookieCard">
                ...
                <div className="buttonContainer">
                    <button className="acceptButton" onClick={engageCookie}>Allow</button>
                    <button className="declineButton" onClick={DeclineCookie}>Decline</button>
                </div>
